...
int main(int argc, char** argv) {
    try {
        ...
        optParse.setSummary("Packs asset folder into a Newborn .pak file");
        optParse.addParameter("c", "configFile", OptionParser::Optional, "JSON file with ognore lists and ordering info");
        optParse.addSwitch("s", "Enable server mode");
        optParse.addSwitch("v", "Verbose, list each file added");
        optParse.addArgument("asset folder path", OptionParser::Required, "Path to assets to be packed");
