...
String Newborn::reprWithLineEnding(FormattedJson const& json) {
...
FormattedJson Newborn::addOrSet(bool add,
...
StringList Newborn::findFiles(FindInput const& findArgs) {
  StringList matches;
