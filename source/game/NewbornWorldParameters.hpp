...
NEWBORN_STRUCT(VisitableWorldParameters);
NEWBORN_STRUCT(TerrestrialWorldParameters);
NEWBORN_STRUCT(AsteroidsWorldParameters);
NEWBORN_STRUCT(FloatingDungeonWorldParameters);
