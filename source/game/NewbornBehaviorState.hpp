...
NEWBORN_CLASS(Blackboard);
NEWBORN_CLASS(BehaviorState);
NEWBORN_STRUCT(ActionState);
NEWBORN_STRUCT(DecoratorState);
NEWBORN_STRUCT(CompositeState);

NEWBORN_EXCEPTION(BehaviorException, NewbornException);
