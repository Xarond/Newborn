...
#include "NewbornNetPacketSocket.hpp"

namespace Newborn {

NEWBORN_CLASS(UniverseConnection);
NEWBORN_CLASS(UniverseConnectionServer);

NEWBORN_EXCEPTION(UniverseConnectionException, NewbornException);
