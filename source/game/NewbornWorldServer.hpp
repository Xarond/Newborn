...
#include "NewbornWorldClientState.hpp"
#include "NewbornCollisionGenerator.hpp"
...
#include "NewbornWeather.hpp"
#include "NewbornInterpolationTracker.hpp"
#include "NewbornWorldStructure.hpp"
#include "NewbornLuaRoot.hpp"
...
NEWBORN_CLASS(Sky);
NEWBORN_STRUCT(SkyParameters);
NEWBORN_CLASS(DamageManager);
NEWBORN_CLASS(WireProcessor);
NEWBORN_CLASS(EntityMap);
NEWBORN_CLASS(WorldStorage);
NEWBORN_CLASS(FallingBlocksAgent);
NEWBORN_CLASS(DungeonDefinition);
NEWBORN_CLASS(WorldServer);
NEWBORN_CLASS(TileEntity);
NEWBORN_CLASS(UniverseSettings);
NEWBORN_CLASS(UniverseServer);

NEWBORN_EXCEPTION(WorldServerException, NewbornException);
