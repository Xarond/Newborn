...
#include "NewbornDungeonImagePart.hpp"
...
namespace Dungeon {
  ...
  BrushConstPtr parseObjectBrush(Json const& brush) {
    ...
    if (settings.contains("direction"))
      ...
      direction = Newborn::Direction::Left;
  ...
  ObjectBrush::ObjectBrush(String const& object, Newborn::Direction direction, Json const& parameters) {
    m_object = object;
  ...
  Vec2I Connector::positionAdjustment() const {
    ...
    if (m_direction == Direction::Up)
      return Vec2I(0, 1);
    newbornAssert(m_direction == Direction::Down);
    return Vec2I(0, -1);
  }
  ...
  void DungeonGeneratorWriter::placeObject(Vec2I const& pos, String const& objectType, Newborn::Direction direction, Json const& parameters) {
