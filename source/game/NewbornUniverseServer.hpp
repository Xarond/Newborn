...
#include "NewbornIdMap.hpp"
#include "NewbornWorkerPool.hpp"
#include "NewbornGameTypes.hpp"
#include "NewbornCelestialCoordinate.hpp"
#include "NewbornServerClientContext.hpp"
#include "NewbornWorldServerThread.hpp"
#include "NewbornSystemWorldServerThread.hpp"
...
NEWBORN_CLASS(ChatProcessor);
NEWBORN_CLASS(CommandProcessor);
NEWBORN_CLASS(TeamManager);
NEWBORN_CLASS(UniverseServer);
NEWBORN_CLASS(WorldTemplate);
NEWBORN_CLASS(WorldServer);
NEWBORN_CLASS(UniverseSettings);

NEWBORN_EXCEPTION(UniverseServerException, NewbornException);
