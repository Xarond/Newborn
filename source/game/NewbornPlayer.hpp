...
#include "NewbornLoungingEntities.hpp"
#include "NewbornChattyEntity.hpp"
#include "NewbornEmoteEntity.hpp"
#include "NewbornDamageBarEntity.hpp"
#include "NewbornNametagEntity.hpp"
#include "NewbornPortraitEntity.hpp"
#include "NewbornInspectableEntity.hpp"
#include "NewbornInventoryTypes.hpp"
#include "NewbornActorMovementController.hpp"
#include "NewbornNetworkedAnimator.hpp"
#include "NewbornAiTypes.hpp"
#include "NewbornItemBag.hpp"
#include "NewbornArmorWearer.hpp"
#include "NewbornEntityRendering.hpp"
#include "NewbornToolUser.hpp"
...
NEWBORN_CLASS(Songbook);
NEWBORN_CLASS(WireConnector);
NEWBORN_CLASS(PlayerInventory);
NEWBORN_CLASS(PlayerBlueprints);
NEWBORN_CLASS(PlayerTech);
NEWBORN_CLASS(PlayerCompanions);
NEWBORN_CLASS(PlayerDeployment);
NEWBORN_CLASS(PlayerLog);
NEWBORN_CLASS(TechController);
NEWBORN_CLASS(ClientContext);
NEWBORN_CLASS(Statistics);
NEWBORN_CLASS(StatusController);
NEWBORN_CLASS(PlayerCodexes);
