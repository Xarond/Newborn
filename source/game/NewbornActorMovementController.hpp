...
#include "NewbornMovementController.hpp"
#include "NewbornPlatformerAStarTypes.hpp"
#include "NewbornAnchorableEntity.hpp"
#include "NewbornGameTimers.hpp"

namespace Newborn {

NEWBORN_EXCEPTION(ActorMovementControllerException, MovementControllerException);

NEWBORN_CLASS(ActorMovementController);
NEWBORN_CLASS(PathController);
