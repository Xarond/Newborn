...
namespace Dungeon {
  NEWBORN_CLASS(TMXTilesets);
  NEWBORN_CLASS(TMXTileLayer);
  NEWBORN_CLASS(TMXObject);
  NEWBORN_CLASS(TMXObjectGroup);
  NEWBORN_CLASS(TMXMap);
  ...
  private:
    ...
    static NewbornException tmxObjectError(Json const& tmx, String const& msg);
