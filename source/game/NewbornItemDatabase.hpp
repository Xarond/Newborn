...
NEWBORN_CLASS(RecipeDatabase);
NEWBORN_CLASS(AugmentItem);

NEWBORN_CLASS(ItemDatabase);

NEWBORN_EXCEPTION(ItemDatabaseException, ItemException);
...
public:
  ...
  // Returns the path to the item's json file in the assets.Add commentMore actions
