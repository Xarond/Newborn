...
NEWBORN_STRUCT(ActionNode);
NEWBORN_STRUCT(DecoratorNode);
NEWBORN_STRUCT(SequenceNode);
NEWBORN_STRUCT(SelectorNode);
NEWBORN_STRUCT(ParallelNode);
NEWBORN_STRUCT(DynamicNode);
NEWBORN_STRUCT(RandomizeNode);
NEWBORN_STRUCT(BehaviorTree);
