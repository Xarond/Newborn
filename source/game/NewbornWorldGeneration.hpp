...
#include "NewbornMicroDungeon.hpp"
...
NEWBORN_CLASS(FallingBlocksWorld);
NEWBORN_CLASS(DungeonGeneratorWorld);
NEWBORN_CLASS(SpawnerWorld);
NEWBORN_CLASS(WorldGenerator);
NEWBORN_CLASS(Plant);
...
public:
  ...
  void placeObject(
      Vec2I const& pos, String const& objectName, Newborn::Direction direction, Json const& parameters) override;
