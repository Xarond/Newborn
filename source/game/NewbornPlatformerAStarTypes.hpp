...
#include "NewbornAStar.hpp"

namespace Newborn {
namespace PlatformerAStar {

NEWBORN_CLASS(PathFinder);
...
template <> struct fmt::formatter<Newborn::PlatformerAStar::Node> : ostream_formatter {};
template <> struct fmt::formatter<Newborn::PlatformerAStar::Action> : ostream_formatter {};
template <> struct fmt::formatter<Newborn::PlatformerAStar::Edge> : ostream_formatter {};
