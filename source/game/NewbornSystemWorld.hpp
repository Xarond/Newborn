...
#include "NewbornSkyParameters.hpp"
...
NEWBORN_CLASS(SystemWorld);
NEWBORN_CLASS(SystemWorldServer);
NEWBORN_CLASS(SystemClientShip);
NEWBORN_CLASS(SystemObject);

NEWBORN_STRUCT(SystemObjectConfig);
