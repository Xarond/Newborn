...
NEWBORN_CLASS(TileDamageParameters);
NEWBORN_CLASS(TileDamageStatus);
NEWBORN_CLASS(EntityTileDamageStatus);

NEWBORN_EXCEPTION(TileDamageException, NewbornException);
