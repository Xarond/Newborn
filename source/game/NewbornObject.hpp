...
#include "NewbornPeriodic.hpp"
#include "NewbornPeriodicFunction.hpp"
...
#include "NewbornStatusEffectEntity.hpp"
...
NEWBORN_STRUCT(ObjectConfig);
NEWBORN_STRUCT(ObjectOrientation);
NEWBORN_CLASS(Object);
