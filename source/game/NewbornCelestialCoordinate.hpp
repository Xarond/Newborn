...
NEWBORN_CLASS(CelestialCoordinate);

NEWBORN_EXCEPTION(CelestialException, NewbornException);
...
template <> struct fmt::formatter<Newborn::CelestialCoordinate> : ostream_formatter {};
