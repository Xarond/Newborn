...
NEWBORN_CLASS(MiningTool);
NEWBORN_CLASS(HarvestingTool);
NEWBORN_CLASS(WireTool);
NEWBORN_CLASS(Flashlight);
NEWBORN_CLASS(BeamMiningTool);
NEWBORN_CLASS(TillingTool);
NEWBORN_CLASS(PaintingBeamTool);
