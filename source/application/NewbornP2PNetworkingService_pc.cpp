#include "NewbornP2PNetworkingService_pc.hpp"
...
void Newborn::PcP2PNetworkingService::setActivityData(
...
Maybe<pair<String, RpcPromiseKeeper<P2PJoinRequestReply>>> Newborn::PcP2PNetworkingService::pullJoinRequest() {
  MutexLocker serviceLocker(m_mutex);
...
void Newborn::PcP2PNetworkingService::update() {
#ifdef NEWBORN_ENABLE_DISCORD_INTEGRATION
  MutexLocker discordLocker(m_state->discordMutex);
#endif
  MutexLocker serviceLocker(m_mutex);
