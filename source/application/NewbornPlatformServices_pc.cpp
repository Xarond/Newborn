...
#include "NewbornStatisticsService_pc_steam.hpp"
#include "NewbornUserGeneratedContentService_pc_steam.hpp"
...
PcPlatformServicesUPtr PcPlatformServices::create([[maybe_unused]] String const& path, StringList platformArguments) {
  ...
  if (services->m_state->discordAvailable) {
    Logger::debug("Registering Newborn to Discord at path: {}", path);
