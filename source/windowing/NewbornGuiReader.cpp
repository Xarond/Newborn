...
WidgetConstructResult GuiReader::titleHandler(String const&, Json const& config) {
  if (m_pane) {
    ...
    throw NewbornException("Only Pane controls support the 'title' command");
  }
...
WidgetConstructResult GuiReader::paneFeatureHandler(String const&, Json const& config) {
  if (m_pane) {
    ...
    throw NewbornException("Only Pane controls support the 'panefeature' command");
  }
...
WidgetConstructResult GuiReader::backgroundHandler(String const&, Json const& config) {
  if (m_pane) {
    ...
    throw NewbornException("Only Pane controls support the 'background' command");
  }
