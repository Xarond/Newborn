...
#include "NewbornMultiArrayInterpolator.hpp"
...
public:
  ...
  typedef Newborn::MultiArray<ElementT, RankN> MultiArray;

  typedef Newborn::MultiArrayInterpolator2<MultiArray, Position> Interpolator2;
  typedef Newborn::MultiArrayInterpolator4<MultiArray, Position> Interpolator4;
  typedef Newborn::MultiArrayPiecewiseInterpolator<MultiArray, Position> PiecewiseInterpolator;
