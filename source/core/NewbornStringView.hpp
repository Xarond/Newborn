...
NEWBORN_CLASS(StringView);
NEWBORN_CLASS(String);

// This is a StringView version of Newborn::String
...
template <> struct fmt::formatter<Newborn::StringView> : formatter<std::string_view> {
  fmt::appender format(Newborn::StringView const& s, format_context& ctx) const;
};
