...
NEWBORN_EXCEPTION(NetworkException, IOException);

NEWBORN_CLASS(HostAddress);
...
template <> struct fmt::formatter<Newborn::HostAddress> : ostream_formatter {};
template <> struct fmt::formatter<Newborn::HostAddressWithPort> : ostream_formatter {};
