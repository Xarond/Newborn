...
NEWBORN_EXCEPTION(JsonException, NewbornException);
NEWBORN_EXCEPTION(JsonParsingException, NewbornException);
...
template <> struct fmt::formatter<Newborn::Json> : ostream_formatter {};
template <> struct fmt::formatter<Newborn::JsonObject> : ostream_formatter {};
