...
template <> struct fmt::formatter<Newborn::String> : formatter<std::string> {
  fmt::appender format(Newborn::String const& s, format_context& ctx) const;
};
