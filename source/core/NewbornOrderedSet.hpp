...
template <typename Value, typename Hash = Newborn::hash<Value>, typename Equals = std::equal_to<Value>, typename Allocator = std::allocator<Value>>
...
template <template <typename...> class Map, typename Value, typename Allocator, typename... Args>
struct fmt::formatter<Newborn::OrderedSetWrapper<Map, Value, Allocator, Args...>> : ostream_formatter {};
