...
NEWBORN_EXCEPTION(BadVariantCast, NewbornException);
NEWBORN_EXCEPTION(BadVariantType, NewbornException);
...
template <typename FirstType, typename... RestTypes>
struct fmt::formatter<Newborn::Variant<FirstType, RestTypes...>> : ostream_formatter {};
