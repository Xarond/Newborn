...
template <typename Key, typename Value, typename Hash = Newborn::hash<Key>, typename Equals = std::equal_to<Key>, typename Allocator = BlockAllocator<pair<Key const, Value>, 1024>>
