...
NEWBORN_STRUCT(ThreadImpl);
NEWBORN_STRUCT(ThreadFunctionImpl);
NEWBORN_STRUCT(MutexImpl);
NEWBORN_STRUCT(ConditionVariableImpl);
NEWBORN_STRUCT(RecursiveMutexImpl);
